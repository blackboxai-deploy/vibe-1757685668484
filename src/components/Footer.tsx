        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Your trusted partner in finding the perfect vehicle. We provide premium cars, excellent service, and competitive financing to help you drive away with confidence.
            </p>
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span>123 Auto Plaza, Carville, CA 90210</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 mb-4 md:mb-0">
              <p>&copy; {currentYear} CCarree. All rights reserved.</p>
            </div>
